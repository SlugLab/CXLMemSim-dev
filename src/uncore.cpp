...
Uncore::Uncore(const uint32_t unc_idx, PerfConfig *perf_config) {
    ...
    this->perf[0] = init_uncore_perf(-1, unc_idx, perf_config->cha_llc_write_back_config,
                                     perf_config->cha_llc_write_back_config1, value);
    this->perf[1] = init_uncore_perf(-1, unc_idx, perf_config->cpu_bandwidth_read_config, 0, value);
    this->perf[2] = init_uncore_perf(-1, unc_idx, perf_config->cpu_bandwidth_write_config, 0, value);
    this->perf[3] = init_uncore_perf(-1, unc_idx, perf_config->cpu_llcl_hits_config, 0, value);
}
